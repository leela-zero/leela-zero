...
* To work successfully, autogtp binary needs to also have leelaz binary to be in the same directory. The below instructions can compile leelaz, and optionally autogtp at the same time if you want.
